...
if(window.console&&window.console.log){console.log("%c Black1ce %c https://black1ce.com ","color: #fff; margin: 1em 0; padding: 5px 0; background: #DC143C;","margin: 1em 0; padding: 5px 0; background: #efefef;")}
